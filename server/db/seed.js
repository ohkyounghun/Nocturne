...
async function seed() {
    ...
    const spotsData = [
        // 먼저 삽입해 지도에는 보이지만 최신 10개 카드 목록에서는 제외한다.
        // Insert first so these appear on the map but stay outside the latest 10 cards.
        [userId, 'Daegu Gangjeong Weir',          'The longest weir on the Nakdong River glowing against the summer night sky', 35.8421, 128.4627, 'summer', 'clear'],
        [userId, 'Ulsan Hwasan Park',             'A quiet hilltop park overlooking Ulsan and its illuminated industrial coast', 35.4348, 129.3369, 'autumn', 'clear'],
        [userId, 'Gangneung Anbandegi',           'A remote highland plateau known for a wide winter night sky above the clouds', 37.6876, 128.8543, 'winter', 'snowy'],
        [userId, 'N Seoul Tower',                  'Iconic tower offering panoramic night views over Seoul',           37.5512, 126.9882, 'winter', 'clear'],
        ...
        [userId, 'Inwangsan Jahamun Tunnel',       'Famous hillside spot overlooking Seoul\'s glittering nightscape', 37.5894, 126.9568, 'spring', 'clear'],
        [userId, 'Naksan Park',                    'Hilltop park along the old Seoul fortress wall with city views',  37.5796, 127.0056, 'autumn', 'clear'],
        [userId, 'Busan Diamond Bridge',           'Iconic suspension bridge illuminated brilliantly at night',       35.1463, 129.1286, 'summer', 'clear'],
        [userId, 'Gwangan Bridge Viewpoint',       'Best spot to view the iconic Gwangan Bridge light show',          35.1530, 129.1185, 'summer', 'clear'],
        [userId, 'Incheon Songdo Central Park',    'Modern waterfront park with dazzling smart city night lights',    37.3927, 126.6428, 'autumn', 'clear'],
        [userId, 'Jeonju Hanok Village',           'Traditional hanok village glowing warmly under lantern lights',   35.8151, 127.1530, 'winter', 'clear'],
        [userId, 'Cheonggyecheon Stream',          'Urban stream lined with colorful light installations at night',   37.5697, 126.9794, 'autumn', 'clear'],
    ];
